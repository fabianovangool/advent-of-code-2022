...
// part 2
const answerPartTwo = calculateAmount("A X", 3) + calculateAmount("A Y", 4) + calculateAmount("A Z", 8) + calculateAmount("B X", 1) + calculateAmount("B Y", 5) + calculateAmount("B Z", 9) + calculateAmount("C X", 2) + calculateAmount("C Y", 6) + calculateAmount("C Z", 7);
